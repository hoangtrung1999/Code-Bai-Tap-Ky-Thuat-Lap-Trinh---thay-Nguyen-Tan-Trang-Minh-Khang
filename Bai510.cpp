...
{
	phansoC.Tu = phansoA.Tu*phansoB.Mau;
	phansoC.Mau = phansoA.Mau*phansoB.Tu;
}
...
int main()
{
	...
	if (phansoC.Mau/(GDC(phansoC.Tu,phansoC.Mau)) > 1)
		cout<<"Tich 2 Phan so da rut gon la: "<<phansoC.Tu/(GDC(phansoC.Tu,phansoC.Mau))<<"/"<<phansoC.Mau/(GDC(phansoC.Tu,phansoC.Mau));
	else if (phansoC.Mau/(GDC(phansoC.Tu,phansoC.Mau)) == 1)
		cout<<"Tich 2 Phan so da rut gon la: "<<phansoC.Tu/(GDC(phansoC.Tu,phansoC.Mau));
	else
