...
int main(int argc, char const *argv[])
{
	...
	cout<<"Ket qua sau khi thuc hien phep nhan hai phan so la: "<<phanso.Tu/(GDC(phanso.Tu,phanso.Mau))<<"/"<<phanso.Mau/(GDC(phanso.Tu,phanso.Mau));
	return 0;
}