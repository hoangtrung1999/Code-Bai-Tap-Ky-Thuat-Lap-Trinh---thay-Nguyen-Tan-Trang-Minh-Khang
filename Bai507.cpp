...
int main()
{
	...
	if (phansoC.Mau/(GDC(phansoC.Tu,phansoC.Mau)) > 1)
		cout<<"Tong 2 Phan so da rut gon la: "<<phansoC.Tu/(GDC(phansoC.Tu,phansoC.Mau))<<"/"<<phansoC.Mau/(GDC(phansoC.Tu,phansoC.Mau));
	else if (phansoC.Mau/(GDC(phansoC.Tu,phansoC.Mau)) == 1)
		cout<<"Tong 2 Phan so da rut gon la: "<<phansoC.Tu/(GDC(phansoC.Tu,phansoC.Mau));
	else
